...
extern unsigned long tasksPeriodGCD; // Start count from here, down to 0. Default 1ms
extern unsigned char tasksNum; // Number of tasks in the scheduler. Default 0 tasks
